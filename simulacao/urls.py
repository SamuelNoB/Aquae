...
urlpatterns = [
    ...
    re_path(r'seleciona-simulacao/(?P<pk>\d+)/$', views.seleciona_simulacao, name='seleciona_simulacao'),
    ...
    re_path(r'simulacao-rac/(?P<pk>\d+)/$', views.SimulacaoRAC.as_view(), name='simulacao-rac')
